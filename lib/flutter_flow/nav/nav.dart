...
class AppStateNotifier extends ChangeNotifier {
  ...
  ElTransportadorOperadoresAuthUser? initialUser;
  ElTransportadorOperadoresAuthUser? user;
  ...
  void update(ElTransportadorOperadoresAuthUser newUser) {
    final shouldUpdate =
