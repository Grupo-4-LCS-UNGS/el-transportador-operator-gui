...
class CustomG4Mapita extends StatefulWidget {
  const CustomG4Mapita({
    super.key,
    this.width,
    this.height,
    this.places,
  ...
  final double? width;
  final double? height;
  final List<PlaceRowStruct>? places;
  ...
  final Future Function(PlaceRowStruct? placeRow)? onClickMarker;

  @override
  State<CustomG4Mapita> createState() => _CustomG4MapitaState();
}

class _CustomG4MapitaState extends State<CustomG4Mapita> {
