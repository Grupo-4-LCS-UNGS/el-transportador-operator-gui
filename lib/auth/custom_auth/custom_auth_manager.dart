...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    elTransportadorOperadoresAuthUserSubject.add(
      ElTransportadorOperadoresAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ElTransportadorOperadoresAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ElTransportadorOperadoresAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ElTransportadorOperadoresAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    elTransportadorOperadoresAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ElTransportadorOperadoresAuthUser? currentUser;
